<template>
  <main style="padding: 60px">
    ...
    <div>
      ...
      <button @click="transferSPLToken">
        TransferSPLToken
      </button>
      <label style="display: block">recipientAddress: <input v-model="transferPayload.recipientAddress" placeholder="recipientAddress" /></label>
      <label style="display: block">amount: <input v-model="transferPayload.amount" type="number" placeholder="amount" /></label>
      <label style="display: block">tokenMint: <input v-model="transferPayload.tokenMint" placeholder="tokenMint" /></label>
      <label style="display: block">tokenDecimals: <input v-model="transferPayload.tokenDecimals" type="number" placeholder="tokenDecimals" /></label>
      <pre v-if="transferResult" v-html="parsedTransferResult" style="white-space: pre-wrap" />
    </div>
    <br />
    <div>
      <h2>Transfer SOL</h2>
      <button @click="transferSOL">
        Transfer SOL
      </button>
      <label style="display: block">recipientAddress: <input v-model="transferSOLPayload.recipientAddress" placeholder="recipientAddress" /></label>
      <label style="display: block">amount: <input v-model="transferSOLPayload.amount" type="number" placeholder="amount" /></label>
      <pre v-if="transferSOLResult" v-html="parsedTransferSOLResult" style="white-space: pre-wrap" />
    </div>
    <br />
    <div>
      ...
      <label style="display: block">name: <input v-model="createVerifiedCollectionPayload.name" placeholder="name" /></label>
      <label style="display: block">symbol: <input v-model="createVerifiedCollectionPayload.symbol" placeholder="symbol" /></label>
      <label style="display: block">metadataUri: <input v-model="createVerifiedCollectionPayload.metadataUri" placeholder="metadataUri" /></label>
    ...
    <div>
      ...
      <label style="display: block">name: <input v-model="mintNFTPayload.name" placeholder="name" /></label>
      <label style="display: block">symbol: <input v-model="mintNFTPayload.symbol" placeholder="symbol" /></label>
    ...
    <div>
      ...
      <label style="display: block">mintAddress: <input v-model="transferNFTPayload.mintAddress" placeholder="mintAddress" /></label>
      <label style="display: block">recipientAddress: <input v-model="transferNFTPayload.recipientAddress" placeholder="recipientAddress" /></label>
      <pre v-if="transferNFTResult" v-html="parsedTransferNFTResult" style="white-space: pre-wrap" />
    </div>
    <br />
    <div>
      <h2>List NFT</h2>
      <button @click="listNFT">
        List NFT
      </button>
...
const parsedTransferResult = computed(() => formatHighlight(JSON.stringify(transferResult.value, null, 2)))
async function transferSPLToken () {
  transferResult.value = await mirrorworld.value.transferSPLToken(transferPayload)
}
...
const parsedTransferSOLResult = computed(() => formatHighlight(JSON.stringify(transferSOLResult.value, null, 2)))
...
const parsedCreateVerifiedCollection = computed(() => formatHighlight(JSON.stringify(createVerifiedCollectionResult.value, null, 2)))
async function createVerifiedCollection () {
  createVerifiedCollectionResult.value = await mirrorworld.value.createVerifiedCollection(
...
const parsedNFT = computed(() => formatHighlight(JSON.stringify(mintNFTResult.value, null, 2)))
...
const parsedTransferNFTResult = computed(() => formatHighlight(JSON.stringify(transferNFTResult.value, null, 2)))
